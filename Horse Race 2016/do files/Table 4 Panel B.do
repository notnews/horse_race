...
qui xi: reg on2016top10 FoxmSlant2   WSJmSlant2 YahoomSlant2 GooglemSlant2   NYTmSlant2 WashPostmSlant2 Google Fox NYT WSJ hpmg Yahoo WashPost  ySd  yD yD2 ySd2 yD2 on2016homepage on2016politics onDay* , cluster(mindate)
est store a
...
estout a b c  , keep (  FoxmSlant2 WSJmSlant2 NYTmSlant2  WashPostmSlant2  YahoomSlant2 GooglemSlant2) style(tex) cells(b(star fmt(3)) se(par)) stats(r2_a N, fmt(%9.3f %9.0g)) starlevels(* 0.10 ** 0.05 *** 0.01)
...
qui xi: reg on2016top10 FoxmSlant2   WSJmSlant2 YahoomSlant2 GooglemSlant2   NYTmSlant2 WashPostmSlant2 Google Fox NYT WSJ hpmg Yahoo WashPost  ySd  yD yD2 ySd2 yD2 on2016homepage on2016politics  i.numHR onDay* , cluster(mindate)
est store aa
