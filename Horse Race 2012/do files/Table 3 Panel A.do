...
est store a
poisson ct other* days*  if src_n==5, vce(bootstrap)
est store b
poisson ct other*  days*  if src_n==3, vce(bootstrap)
est store c
poisson ct other* days*   if src_n==2, vce(bootstrap)
est store d

poisson ct other_c* poll if src_n==1, vce(bootstrap)
est store a2
poisson ct other_c* poll if src_n==5, vce(bootstrap)
est store b2
poisson ct other_c* poll if src_n==3, vce(bootstrap)
est store c2
poisson ct other_c* poll if src_n==2, vce(bootstrap)
est store d2
